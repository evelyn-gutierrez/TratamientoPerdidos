...
- En el siguiente gráfico observamos el mismo tipo de diagrama. Esta vez enfocado en el análisis de la variable **NonD** (note la diferencia en la formula utilizada). 
